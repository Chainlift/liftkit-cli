...
export const extractRegistryDependencies = (item: RegistryItem): string[] => item.registryDependencies || [];
...
export const calculateInstallationOrder = (tree: DependencyNode): RegistryItem[] => {
...
// Main API functions
export const processRegistry = async (url?: string): Promise<SchemaProcessor> => {
